...
import com.studios.world.World;
...
public class Enemy extends Entity {
	...
	public Enemy(int x, int y, int width, int height, BufferedImage Spritesheet) {
		...
		for (int i = 0; i < 5; i++) {
			...
			RightEnemy[i] = Game.enemySheet.getSprite(160, 80 + (World.TILE_SIZE * i), World.TILE_SIZE,
					World.TILE_SIZE);
		...
		for (int i = 0; i < 5; i++) {
			...
			LeftEnemy[i] = Game.enemySheet.getSprite(144, 80 + (World.TILE_SIZE * i), World.TILE_SIZE, World.TILE_SIZE);

		}

		for (int i = 0; i < 5; i++) {

			TopEnemy[i] = Game.enemySheet.getSprite(112, 80 + (World.TILE_SIZE * i), World.TILE_SIZE, World.TILE_SIZE);

		}

		for (int i = 0; i < 5; i++) {

			DownEnemy[i] = Game.enemySheet.getSprite(128, 80 + (World.TILE_SIZE * i), World.TILE_SIZE, World.TILE_SIZE);

		}

		for (int i = 0; i < 5; i++) {

			RightEnemyDamege[i] = Game.enemySheet.getSprite(160, 176 + (World.TILE_SIZE * i), World.TILE_SIZE,
					World.TILE_SIZE);
		...
		for (int i = 0; i < 5; i++) {
			...
			LeftEnemyDamege[i] = Game.enemySheet.getSprite(144, 176 + (World.TILE_SIZE * i), World.TILE_SIZE,
					World.TILE_SIZE);
		...
		for (int i = 0; i < 5; i++) {
			...
			TopEnemyDamege[i] = Game.enemySheet.getSprite(112, 176 + (World.TILE_SIZE * i), World.TILE_SIZE,
					World.TILE_SIZE);
		...
		for (int i = 0; i < 5; i++) {
			...
			DownEnemyDamege[i] = Game.enemySheet.getSprite(128, 176 + (World.TILE_SIZE * i), World.TILE_SIZE,
					World.TILE_SIZE);
